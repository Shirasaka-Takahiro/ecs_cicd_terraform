...
##Public Access Block for ALB access log
...
##Public Access Block for Codepipeline
resource "aws_s3_bucket_public_access_block" "bucket_public_access_codepipeline" {
